...
{
    internal class ShimFileTransformation2 : IRequireTransformation
    {
        private List<string> dependencies;

        private string moduleName;

        public ShimFileTransformation2(string moduleName, List<string> dependencies)
        {
        ...
        public static ShimFileTransformation2 Create(string moduleName, List<string> dependencies)
        {
            return new ShimFileTransformation2(moduleName, dependencies);
        }
        ...
        public void Execute(ref string script)
        {
            ...
            script = string.Format("{2}{3}{2}define('{0}', {1}, function () {{}});", moduleName.ToModuleName(), depString, Environment.NewLine, script);
        }
